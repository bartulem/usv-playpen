...
@click.option('--length-threshold', 'length_threshold', type=int, default=None, required=False, help='Drop USVs with duration > threshold (time bins); the stored 128-column mask truncates longer calls.')
@click.option('--min-duration', 'min_duration', type=int, default=None, required=False, help='Drop USVs with duration < this (time bins).')
