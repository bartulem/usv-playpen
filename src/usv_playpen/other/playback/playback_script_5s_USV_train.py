...
def run_playback_files(num_seq, io_pin_id, audio_directory, audio_playback_gain):
    ...
    for i in range(num_seq):
        ...
        # play audio file
        subprocess.Popen(
            args=f"""AUDIODEV=hw:3,0 play -r 192k -v {audio_playback_gain} {wav_file_lst[random_int_lst[i]]}""",
            shell=True,
            cwd=audio_directory,
        ).wait()
