...
@click.option('--seam-repair/--no-seam-repair', 'seam_repair_bool', default=None, required=False, help='Run the post-summary seam check-and-repair (default: enabled). Pass --no-seam-repair to leave seam-snapped USV boundaries as detected.')
