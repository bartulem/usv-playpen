...
class FindMouseVocalizations:
    ...
    def repair_seam_snapped_boundaries(self) -> None:
        ...
        # Phase 1: merged-level width gate. Merged gap widths sit up to the
        # watershed-trim below the exact raw ladder values, hence the
        # asymmetric tolerance window around each stride multiple.
