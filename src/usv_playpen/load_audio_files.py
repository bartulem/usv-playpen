            ...
            for one_file in sorted(os.listdir(one_dir)):
                ...
                if ".wav" in one_file and additional_condition:
                    ...
                    if (
                        ...
                        try:
                            (
                                wave_data_dict[one_file]["sampling_rate"],
                                wave_data_dict[one_file]["wav_data"],
                        ...
                        (
                            wave_data_dict[one_file]["wav_data"],
                            wave_data_dict[one_file]["sampling_rate"],
                        ) = librosa.load(f"{one_dir}{os.sep}{one_file}")
                    wave_data_dict[one_file]["dtype"] = self.known_dtypes[
                        type(wave_data_dict[one_file]["wav_data"].ravel()[0]).__name__
                    ]
