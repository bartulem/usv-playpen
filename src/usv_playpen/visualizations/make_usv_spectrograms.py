...
def render_embedding_thumbnails_for_cohort(
    ...
    try:
        ...
        # The combined session list was a throwaway for the pooling step; remove it
        # so repeated GUI runs do not leak temp files.
        pathlib.Path(combined_sessions_txt).unlink(missing_ok=True)
