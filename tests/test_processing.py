...
class TestProcessing(unittest.TestCase):
    ...
    def test_send_email(self):
        ...
        try:
            Messenger(
                receivers=email_receiver, exp_settings_dict=self.esd
            ).send_message(
                subject="Test",
    ...
    def test_video_processing(self):
        ...
        try:
            subprocess.Popen(
                args=f"""{self.command_addition}ffmpeg -version""",
        ...
        self.assertTrue(
            expr=video_processing_success,
            msg="FFMPEG not functional from command line.",
        )

    def test_audio_processing(self):
        try:
            subprocess.Popen(
                args=f"""{self.command_addition}sox --version""",
                shell=self.shell_usage_bool,
            ).wait()
        ...
        self.assertTrue(
            expr=audio_processing_success, msg="SOX not functional from command line."
        )
