...
When Calibration is complete, you can leave the board on the floor and click the *Record* button, which will capture a minute long video of the empty arena. You do not want to move around in the arena space during this recording. Upon completion, the data will be copied over to the directories/fileserver(s) you selected previously, *e.g.*, /mnt/falkner/Bartul/Data/20250430_142022 and there will be two subdirectories: *sync* and *video*. In the *video* subdirectory, you will find Nx (N = number of cameras) calibration subdirectories (containing 3 minute calibration videos) and Nx recording subdirectories (containing the 1 minute video post calibration).
...
When Calibration is done, if you navigate to, *e.g.*, /mnt/falkner/Bartul/Data/20250430_142022/20250430142022/video, you will find, among others, a *20250430142022_calibration.toml* file and a *20250430142022_reprojection_histogram.png* file. The histogram should display the reprojection error diminishing steeply with pixel number (see image below for example), highly suggestive of an effective calibration.
...
.. code-block:: toml
    ...
    device_sn = '75830333737351917142'
    device_br = 9600
